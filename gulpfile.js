...
const tapePath = `tape`; //require.resolve(`tape/bin/tape`);
const tsNodePath = `ts-node`; //require.resolve(`ts-node/dist/bin`);
const tapDiffPath = `tap-difflet`; //require.resolve(`tap-difflet/bin/tap-difflet`);
...
}))({}, `tsickle` /*require.resolve(`tsickle/built/src/main`)*/);
